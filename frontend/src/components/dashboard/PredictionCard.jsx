    ...
    <section className="rounded-2xl border border-[#e2e8e4] bg-white p-6 shadow-sm dark:border-slate-700 dark:bg-slate-900">
      ...
      <div className="mt-6 flex items-center gap-5">
        ...
        <div>
          ...
          <h3 className="text-base font-medium text-[#1f3f31] dark:text-white">Mood cenderung Baik</h3>
        </div>
      </div>
      ...
      <div className="mt-7 grid gap-4 sm:grid-cols-2">
        <div className="rounded-xl bg-[#f0f4f7] p-4 dark:bg-slate-800">
          ...
          <h4 className="mt-2 text-lg font-medium text-[#1f3f31] dark:text-white">78%</h4>
        </div>

        <div className="rounded-xl bg-[#f0f4f7] p-4 dark:bg-slate-800">
          <p className="text-xs text-[#60766b] dark:text-slate-400">Status</p>

          <span className="mt-2 inline-flex rounded-full bg-[#d8f7e8] px-3 py-1 text-xs font-medium text-[#2b6a4f] dark:bg-emerald-950/50 dark:text-emerald-300">Kondisi Baik</span>
        </div>
      </div>
      ...
      <div className="mt-7">
        ...
        <p className="mt-2 text-sm leading-6 text-[#1f3f31] dark:text-slate-300">Tidur cukup, aktivitas stabil, stres menurun</p>
      </div>
